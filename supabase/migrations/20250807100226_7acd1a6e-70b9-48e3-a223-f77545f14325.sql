-- Create 1:1 relationship between jobs and companies tables
-- Make job_id NOT NULL and UNIQUE to ensure 1:1 relationship
ALTER TABLE companies 
  ALTER COLUMN job_id SET NOT NULL,
  ADD CONSTRAINT companies_job_id_unique UNIQUE (job_id),
  ADD CONSTRAINT companies_job_id_fkey FOREIGN KEY (job_id) REFERENCES jobs(id) ON DELETE CASCADE;
