        ...
        <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
          <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
            <h1 className="text-4xl font-bold tracking-tight text-neutral-900 sm:text-6xl hero-element">
              {t('title', { ns: 'hero', defaultValue: 'Say Goodbye to Lost Resumes - Let Ooze and Seeker Open the Door to Your Dream Job!' })}
            </h1>
            <p className="relative mt-6 text-lg leading-8 text-neutral-600 sm:max-w-md lg:max-w-none hero-element">
              {t('subtitle', { ns: 'hero', defaultValue: 'Resume Alchemist is the AI-powered resume builder that helps you craft a resume that gets you hired.' })}
            </p>
            <div className="mt-10 flex items-center gap-x-6">
              ...
              >
                {t('getStarted', { ns: 'hero', defaultValue: 'Get started' })}
              </a>
              <a href="/faq" className="text-sm font-semibold leading-6 text-neutral-900 hero-element">
                {t('learnMore', { ns: 'hero', defaultValue: 'Learn more' })} <span aria-hidden="true">→</span>
              </a>
            </div>
          </div>
            ...
            <div className="ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:order-none xl:pt-80">
              <div className="relative">
                <img
                  ...
                  alt=""
                  className="aspect-[2/3] w-full rounded-xl bg-neutral-900/5 object-cover shadow-lg hero-element"
                />
              </div>
            </div>
