...
import { H1, H2, H3, SEOImage } from "@/components/seo/StructuredHeadings";
...
const Index = () => {
  ...
  return (
    <>
      <SEO
        title="Resume Alchemist - AI-Powered Resume Optimization"
        description="Transform your resume with AI-powered optimization. Get matched to your dream job with our intelligent resume builder. Start with 3 free uses."
        keywords="AI resume optimization, resume builder, job matching, AI-powered resume, resume enhancement, job application, career optimization"
        canonicalUrl="https://resumealchemist.qwizai.com/"
        ogType="website"
      />
      ...
      <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-neutral-100 relative">
        ...
        <section id="features" className="py-20 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <H2 className="text-center mb-12 hero-element">How It Works</H2>
        ...
        <section className="py-20 bg-gradient-primary text-white">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <H2 className="text-4xl font-bold mb-6 hero-element text-white">Start with 3 Free Uses</H2>
        ...
        <section id="supported-websites" className="py-20 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <H2 className="text-center mb-12 hero-element">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <H3 className="hero-element">Global Platforms</H3>
                </div>
